        ...
        {products.map((item) => {
          return (
            <div
              ...
              key={item.id}
              className="border shadow box"
            >
              <img width={"100%"} src={item.image} alt="Product Image" />
              <p>
                <span className="fw-bolder">Brand:</span> {item.brand}
              </p>
              <p>
                <span className="fw-bolder">Title:</span> {item.title}
              </p>
              <p>
                <span className="fw-bolder">Category:</span> {item.category}
              </p>
              <p>
                <span className="fw-bolder">Price:</span> Rs. {item.price}
              </p>
            </div>
          );
        })}
